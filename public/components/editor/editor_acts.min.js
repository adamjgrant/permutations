m.editor.acts({set_value(e,t){return m.editor.self.setValue(t.value)},get_value(e,t){return m.editor.self.getValue()},set_default_text(e,t){e.act.set_value({value:m.editor.default_text})},set_cleared_text(e,t){e.act.set_value({value:`{ 
  "main": [] 
}
