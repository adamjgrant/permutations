...
class Branch {
    ...
    sample_branches() {
        ...
        if (branches_to_sample > this.sampled_array.length)
            branches_to_sample = this.sampled_array.length;
        // With thanks to https://stackoverflow.com/a/19270021/393243
        let result = new Array(branches_to_sample), len = this.sampled_array.length, taken = new Array(len);
